app.component('photo-search', {
    ...
    <div class = "ml-20">
        <div class="flex">
            ...
            <!-- cancel button -->
            <button @click = "deleteSearchName" @click = "$emit('cancel-button')" class="ml-10 mt-10 text-md bg-white hover:bg-gray-200 text-gray-700 font-mono font-medium py-2 px-4 border border-gray-400 rounded shadow">cancel</button>
        </div>
        <!-- text No Photos -->
